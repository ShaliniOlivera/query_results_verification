...
# Directories for SQL queries and results
...
for query1_file, query2_file in sql_files:
    ...
    has_mismatch = False  # Track if any mismatches occur
    ...
    for id_value in df1.index:
        if id_value in df2.index:
            ...
            for col in comparison_columns[1:]:  # Skip "id" column
                if col in df1.columns and col in df2.columns:
                    ...
                    if status == "MISMATCH":
                        ...
                        has_mismatch = True  # Mark mismatch found
    ...
    # Determine final status for "Processed" sheet
